...
local function watch_fight(name)
	if playerinpvp[name] then
		local pp = playerinpvp[name]
		local newtime = pp + battletimeout
		playerinpvp[name] = newtime
		if newtime >= battletimeout then
			endtimer(name)
		else
			minetest.after(battletimeout, watch_fight, name)
		end
	end
end
...
local function setplayerpvp(playername)
	if not playerinpvp[playername] then
		...
		minetest.after(battletimeout, watch_fight, playername)
